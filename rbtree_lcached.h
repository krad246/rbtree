 ...
 * @param[in] copy Copy callback used for successor node deletion.
 */
void rb_tree_lcached_delete(rb_tree_lcached_t *tree, rb_node_t *node, rb_iterator_t *deleted, int (*cmp)(const rb_node_t *left, const rb_node_t *right), void (*copy)(const rb_node_t *src, rb_node_t *dst));
